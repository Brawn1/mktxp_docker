...
- from [Docker image](https://hub.docker.com/r/guenterbailey/mktxp) : `❯ docker pull guenterbailey/mktxp:latest`
...
```
docker run -v "$(pwd)/mktxp:/home/mktxp/mktxp/" -p 49090:49090 -it --rm guenterbailey/mktxp:latest
```
